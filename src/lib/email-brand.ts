// Al Hamra brand-compliant email shell (client-side mirror of
// supabase/functions/_shared/email-brand.ts). Keep both files in sync.
//
...
export function brandedFactsTable(rows: { label: string; value: string }[]): string {
  return `
